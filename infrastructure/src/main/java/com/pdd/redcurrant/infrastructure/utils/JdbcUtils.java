...
public class JdbcUtils {
    ...
    /**
     * Builds a callable SQL statement using placeholders for parameters.
     * Ensures safety by not concatenating raw input into the SQL string.
     *
    ...
    public static String buildCallStatement(String procedureName, Object... params) {
        ...
        return "{CALL " + procedureName + "(" + placeholders + ")}"; // Use braces for stored procedures (standard SQL syntax)
    }
